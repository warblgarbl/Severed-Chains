...
public class PartySettingsScreen extends VerticalLayoutScreen {
  private final Runnable unload;

  public PartySettingsScreen(final ConfigCollection config, final Set<ConfigStorageLocation> validLocations, final ConfigCategory category, final Runnable unload) {
